...
AudioSynthNoiseWhite     noise1;         //xy=300,539
AudioSynthNoiseWhite     noise4;         //xy=298,1067
AudioSynthNoiseWhite     noise0;         //xy=301,356
AudioSynthNoiseWhite     noise2;         //xy=301,721
AudioSynthNoiseWhite     noise5;         //xy=299,1238
AudioSynthWaveform       sub1;           //xy=303,496
AudioSynthWaveform       sub4;           //xy=301,1024
AudioSynthWaveform       sub0;           //xy=304,312
AudioSynthNoiseWhite     noise3;         //xy=302,894
AudioSynthNoiseWhite     noise6;         //xy=300,1413
AudioSynthWaveform       sub2;           //xy=304,677
AudioSynthWaveform       sub5;           //xy=302,1195
AudioSynthWaveform       pulseLFO1;      //xy=306,413
AudioSynthWaveform       pulseLFO4;      //xy=304,941
AudioSynthWaveform       pulseLFO0;      //xy=307,229
AudioSynthNoiseWhite     noise7;         //xy=302,1585
AudioSynthWaveform       sub6;           //xy=303,1370
AudioSynthWaveform       pulseLFO2;      //xy=307,594
AudioSynthWaveform       sub3;           //xy=306,851
AudioSynthWaveform       pulseLFO5;      //xy=305,1112
AudioSynthWaveform       saw4;           //xy=306,976
AudioSynthWaveform       saw0;           //xy=309,265
AudioSynthWaveform       saw1;           //xy=309,449
AudioSynthWaveform       pulseLFO3;      //xy=308,767
AudioSynthWaveform       pulseLFO6;      //xy=306,1286
AudioSynthWaveform       saw5;           //xy=307,1148
AudioSynthWaveform       sub7;           //xy=306,1542
AudioSynthWaveform       saw2;           //xy=310,630
AudioSynthWaveform       pulseLFO7;      //xy=308,1458
AudioSynthWaveform       saw3;           //xy=311,803
AudioSynthWaveform       saw6;           //xy=309,1322
AudioSynthWaveform       saw7;           //xy=311,1494
AudioMixer4              oscMixer4;      //xy=503,1019
AudioMixer4              oscMixer0;      //xy=506,307
AudioMixer4              oscMixer1;      //xy=506,491
AudioMixer4              oscMixer5;      //xy=504,1190
AudioMixer4              oscMixer2;      //xy=507,672
AudioMixer4              oscMixer3;      //xy=508,846
AudioMixer4              oscMixer6;      //xy=506,1365
AudioMixer4              oscMixer7;      //xy=508,1537
AudioFilterStateVariable hpf1;           //xy=648,502
AudioFilterStateVariable hpf4;           //xy=646,1030
AudioFilterStateVariable hpf0;           //xy=649,318
AudioFilterStateVariable hpf2;           //xy=649,683
AudioFilterStateVariable hpf5;           //xy=647,1201
AudioFilterStateVariable hpf6;           //xy=648,1375
AudioFilterStateVariable hpf3;           //xy=651,857
AudioFilterStateVariable hpf7;           //xy=651,1548
AudioFilterStateVariable lpf1;           //xy=781,522
AudioFilterStateVariable lpf4;           //xy=779,1049
AudioFilterStateVariable lpf0;           //xy=782,338
AudioFilterStateVariable lpf2;           //xy=782,703
AudioFilterStateVariable lpf5;           //xy=780,1220
AudioFilterStateVariable lpf3;           //xy=783,876
AudioFilterStateVariable lpf6;           //xy=781,1395
AudioFilterStateVariable lpf7;           //xy=783,1567
AudioEffectEnvelope      env1;           //xy=919,522
AudioEffectEnvelope      env4;           //xy=917,1050
AudioEffectEnvelope      env0;           //xy=920,338
AudioEffectEnvelope      env2;           //xy=920,703
AudioEffectEnvelope      env5;           //xy=918,1221
AudioEffectEnvelope      env3;           //xy=920,868
AudioEffectEnvelope      env6;           //xy=919,1396
AudioEffectEnvelope      env7;           //xy=921,1568
AudioMixer4              EnvMixer0;      //xy=1175,445
AudioMixer4              EnvMixer1;      //xy=1175,777
AudioMixer4              EnvMixer3;      //xy=1184,1446
AudioMixer4              EnvMixer2;      //xy=1187,1094
AudioMixer4              mixerL;         //xy=1414,896
AudioMixer4              mixerR;         //xy=1421,1132
AudioEffectFlange        flangerL;       //xy=1594,984
AudioEffectFlange        flangerR;       //xy=1599,1109
AudioAnalyzePeak         peak;           //xy=1618,460
AudioOutputI2S           i2s1;           //xy=1790,1036
...
AudioControlSGTL5000     sgtl5000_1;     //xy=1571,790
